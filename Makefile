...
$(BIN): main.c
	$(CC) $(CFLAGS) $(PKG_CFLAGS) -DDATADIR=\"$(DATADIR)\" $(CPPFLAGS) $(LDFLAGS) main.c $(PKG_LIBS) -o $(BIN)
...
test: test_terminal.c main.c
	$(CC) $(CFLAGS) $(PKG_CFLAGS) -DDATADIR=\"$(DATADIR)\" $(CPPFLAGS) $(LDFLAGS) test_terminal.c $(PKG_LIBS) -o test_terminal
	./test_terminal
	@rm -f test_terminal
